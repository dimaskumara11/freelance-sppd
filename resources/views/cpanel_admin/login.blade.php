...
<head>
  ...
  <link rel="icon" type="image/png" href="{{env('APP_URL')}}/assets/images/favicon.png">
  <title>
    {{env("APP_NAME")}}
  </title>
  <!--     Fonts and icons     -->
      ...
      <div class="container">
        <div class="row">
          <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
            <div class="card mt-8">
                @include('cpanel_admin.helper.alert_notif')
              <div class="card-header pb-0 text-left bg-transparent">
                <h3 class="font-weight-bolder text-info text-gradient">APLIKASI E-SPPD</h3>
